...
public class BookingPresenter implements ViewObserver {
    ...
    private void showReservationChange(int reservation){
        view.showReservationChange(reservation);
    }
    ...
    public void changeReservationTable(int oldReservation, Date reservationDate,  int tableNo, String name){
        int reservation = model.changeReservationTable(oldReservation,reservationDate, tableNo,name);
        showReservationChange(reservation);
    }
