package DZ_Sem_5.views;

import DZ_Sem_5.models.Table;
import DZ_Sem_5.presenters.View;
import DZ_Sem_5.presenters.ViewObserver;
...
public class BookingView implements View {
    ...
    public void showReservationChange(int reservation) {
        if (reservation > 0){
            System.out.printf("Ваша бронь №%d успешно удалена!\n", reservation);
        }
        else {
            System.out.println("Ошибка! Такой брони нет!");
        }
    }
